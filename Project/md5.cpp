...
//    }
//
//    __host__ __device__ md5_t::md5_t(const void* input, const unsigned int input_length, void* signature) {
...
//    }
//
//    __host__ __device__ void md5_t::finish(void* signature_) {
//        if (!finished) {
...
//    }
//
//    __host__ __device__  extern void sig_to_string(const void* signature_, char* str_, const int str_len) {
//        unsigned char* sig_p;
//        char* str_p;
//        char* max_p;
...
//    }
//
//    __host__ __device__  extern "C" void sig_from_string(void* signature_, const char* str_) {
//        unsigned char *sig_p;
//        const char *str_p;
//        char* hex;
